--To Select the Data Base On Which Operation is Going to Be Performed
...
/*
	Query-2:: Write separate queries to list all AdventureWorks customers who 
...
/*
	Query-3:: Show the most recent five orders that were purchased from account
